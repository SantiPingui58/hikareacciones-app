...
class AuthController extends Controller
{
    ...
    public function twitchCallback(Request $request)
    {
        ...
        if ($this->hasSuscription($userInfo['id'],$accessToken)) {
            // Guardar o actualizar el usuario de Twitch en la base de datos
            ...
            return redirect()->route('panel')->with('twitchUser', $twitchUser);
                 ...
                 TwitchUser::where('twitch_id', $userInfo['id'])->delete();
            // Si la respuesta indica que el usuario no está suscrito al canal
